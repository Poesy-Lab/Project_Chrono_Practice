...
| 구분 | 파일 | 사용 위치 |
| --- | --- | --- |
| Mermaid 조합도 | [images/mermaid/](images/mermaid/) | 2.3.1-2.3.6 각 System의 Command-Component-System 조합 구조 |
| 충돌 System 결과 | [system_figure_01.png](images/system_figure_01.png), [system_figure_02.png](images/system_figure_02.png), [system_figure_03.png](images/system_figure_03.png) | 2.3.1 충돌 장면, 접촉력, 충격량 |
| 화성 지형 주행 결과 | [scm_pockmarked_mars_heightmap.png](images/scm_pockmarked_mars_heightmap.png), [system_figure_04.jpg](images/system_figure_04.jpg), [system_figure_05.png](images/system_figure_05.png), [system_figure_06.png](images/system_figure_06.png) | 2.3.2 Heightmap, SCM 주행, 차체 높이, pitch/roll |
| 커스텀 로버/환경 설계 | [system_figure_07.png](images/system_figure_07.png), [system_figure_08.png](images/system_figure_08.png), [system_figure_09.png](images/system_figure_09.png) | 2.3.4-2.3.5 로버 구조와 장애물 환경 |
| 주행 실험 결과 | [system_figure_10.png](images/system_figure_10.png) - [system_figure_25.png](images/system_figure_25.png) | 2.3.6 직진, 조향, slalom, pivot, waypoint, PPO 실험 |
