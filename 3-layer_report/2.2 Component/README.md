...
*그림 2.2-1. 이 그림은 2.2 전체의 전역 색인이다. 중앙 장면의 로버, 지형, 장애물, 접촉점, 센서, 출력 산출물을 먼저 보고, 어떤 Component를 설계해야 하는지 정한 뒤 해당 문서의 Component 카드로 들어간다.*
...
*그림 2.2-2. Chrono 공식 모듈과 보고서 Component 범위의 대응 관계*
...
*그림 2.2-3. Chrono 선택 모듈의 의존성과 검증 수준을 단계별로 정리한 구조*
...
*그림 2.2-4. Core physics, solver, constraint Component의 책임 범위*
...
*그림 2.2-5. 로버/차량, 지형, 충돌/접촉, 데이터/센서 Component의 대표 시각자료*
...
| Mermaid 관계도 | `code/common/render_mermaid_01.py` ~ `code/common/render_mermaid_07.py` |
