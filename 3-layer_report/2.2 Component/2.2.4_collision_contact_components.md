...
| 시각 자료 |
|---|
| ![Collision shape measurement scene](collision_contact_components.png) |

**설명.** VSG로 캡처한 접촉 측정 장면이다. 파란 body와 빨간 obstacle은 각각 collision shape을 가진 body이고, 초록/주황 marker는 속도 방향과 접촉력 측정 방향을 개념적으로 나타낸다.

| 시각 자료 |
|---|
| ![Visual collision difference](collision_visual_vs_collision_shape.png) |
...
| 그래프 |
|---|
| ![Contact material effect graph](collision_contact_material_effect_graph.png) |
...
| 그래프 |
|---|
| ![Collision event timeline](collision_event_timeline_graph.png) |
...
| Debug 렌더 |
|---|
| ![Contact debug vectors](collision_contact_debug_vectors.png) |
