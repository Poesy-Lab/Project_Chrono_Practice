...
| 시각/그래프 자료 |
|---|
| ![Ground obstacle component](terrain_ground_obstacle_components.png) |

**설명.** 회색 평판이 Ground Component이다. 가장 단순한 환경이지만 모든 충돌/주행 실험의 기준 높이와 기준 마찰을 제공한다.

| 시각/그래프 자료 |
|---|
| ![Terrain contact force probe](terrain_contact_force_probe.png) |
...
| 시각 자료 |
|---|
| ![Obstacle component](terrain_ground_obstacle_components.png) |
...
| 시각/그래프 자료 |
|---|
| ![Contact material regions](terrain_contact_material_regions.png) |

**설명.** 회색/주황색 patch는 서로 다른 contact material 영역을 나타낸다. 같은 wheel path라도 영역별 마찰이 달라지면 구동력, slip, 제동거리 해석이 달라진다.

| 시각/그래프 자료 |
|---|
| ![Contact material friction map](terrain_contact_material_friction_map.png) |
...
| 시각 자료 |
|---|
| ![Rigid terrain patch component](terrain_rigid_patch_component.png) |
...
| 시각/그래프 자료 |
|---|
| ![Rigid terrain and heightmap component](terrain_heightmap_component.png) |

**설명.** VSG로 캡처한 Heightmap 형태의 rigid patch 개념이다. RigidTerrain은 바퀴 하중에 의해 변형되지 않고, 지형 높이/법선/마찰 정보를 차량 subsystem에 제공한다.

| 시각/그래프 자료 |
|---|
| ![Terrain height and sinkage profile](terrain_height_sinkage_profile.png) |
...
| 시각/그래프 자료 |
|---|
| ![SCM terrain deformation component](terrain_scm_deformation_component.png) |
...
| 시각 자료 |
|---|
| ![Environment field component](terrain_environment_field_component.png) |
